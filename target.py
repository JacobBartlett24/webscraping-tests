...
cookies = {
    ...
    'accessToken': 'eyJraWQiOiJlYXMyIiwiYWxnIjoiUlMyNTYifQ..lgs9eGS3vEX_YMc-I_EsJbgjk1dPcHHViOA-hLzNaAXAuA41kKWBMxPVPp34WFljVksL5t8KCQUMR5sefrTRkIpAdXmGtfMfucU86cV2d-MZD8q7vCx17XgE5MqJOGpO4UjzyL3nx8TZJp-awVQzRYwxOUKX2lrmU8SUIb7ONjBfUNyPxBsd1K9wwd3c8jrC7OT7_U8XerRCNKiM6EuvIk1nzemnIW_QIdHt4V7KkC2IH_1K3ITMmWbTsBmVWku8NTvD57IPqfOHULhI8RD3SyiaumB9qUb0SKMkqUbpMBuIUaHSu8X7qveD1PtO-jZMWUWCmjqGjmx8k4csRpNGQg',
    'idToken': 'eyJhbGciOiJub25lIn0..',
    'refreshToken': 'ax40mMv4Zfnb7IzNUCsynjH2V1sLMTmj1HxaOtqG9nKK3ExX_b5F4n8zELmMPm-VGTBV6d33Vat6en-KRBYOSg',
    ...
    '_gid': 'GA1.2.1291468420.1676668624',
    ...
    '_mitata': 'ZDg2Y2RlOTA0ZmJhYWNiY2U1NTdmNzhmNzM0OTIxNzYyMmMyYjVmODFjOTJiMjkyNGIyNGE2NTgxZjlhNDA5Zg==_/@#/1676750424_/@#/ctnXdTClgORooqSD_/@#/MzkxYmJlNDJkNzA5OTc3NGFiOGYwMWFhYTUxNjY2YTIxM2Y1NjE1OTk5ZjBiMzRhYTU3MzA5MWI0Mjg0OWRjNw==_/@#/000',
    'ffsession': '{%22sessionHash%22:%229316a55e22a721676667747678%22%2C%22prevPageName%22:%22search:%20search%20results%22%2C%22prevPageType%22:%22search:%20search%20results%22%2C%22prevPageUrl%22:%22https://www.target.com/s?searchTerm=vinyl+records&tref=typeahead%257Cterm%257C0%257Cvinyl+records%257Cvinyl+records%257C%257C%257Cservice%257C10%257C%257C%257C&category=0%257CAll%257Cmatchallpartial%257Call+categories&searchTermRaw=&sortBy=Featured&moveTo=product-list-grid%22%2C%22prevSearchTerm%22:%22vinyl%20records%22%2C%22sessionHit%22:23}',
...
headers = {
    ...
    'referer': 'https://www.target.com/s?searchTerm=vinyl+records&tref=typeahead%7Cterm%7C0%7Cvinyl+records%7Cvinyl+records%7C%7C%7Cservice%7C10%7C%7C%7C&category=0%7CAll%7Cmatchallpartial%7Call+categories&searchTermRaw=&sortBy=Featured&moveTo=product-list-grid',
...
def formatAsJson(response):
  json_formatted_str = json.loads(response.text)

  turnJSONintoReadable(json_formatted_str)

  return json_formatted_str

def turnJSONintoReadable(json_formatted_str):
