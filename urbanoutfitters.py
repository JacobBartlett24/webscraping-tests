...
headers = {
    ...
    'authorization': 'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..u6skUK7MLjIAiaiBcTc0jpqrzlMf1w-lWBvaVPWtwjo',
...
def insertVinylInfo(data, offset):
    ...
    for record in data['records']:
      vinyl = {
        ...
        'price': record['allMeta']['tile']['skuInfo']['listPriceLow'],
      }
