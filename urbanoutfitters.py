...
headers = {
    ...
    'authorization': 'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..NaWZk0UJWhq7Cx7u1X0Ih0Uo2m6h0n14igGbmD1R2W0',
...
def insertVinylInfo(data, offset):
    ...
    for record in data['records']:
      print(record['allMeta']['tile']['product']['displayName'])
      print(f"https://www.urbanoutfitters.com/shop/{record['allMeta']['tile']['product']['productSlug']}")
      print(record['allMeta']['tile']['skuInfo']['listPriceLow'])
    time.sleep(10)
